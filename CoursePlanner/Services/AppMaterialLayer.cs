...
public enum AppColorRole
{
    ...
    CourseBlockHover,
    CourseBlockLocked,
    CourseBlockLockedHover,
    CourseBlockOutOfWeek,
    CourseBlockOutOfWeekHover,
    CourseBlockOutOfWeekText,
    CourseBlockAdded,
    CourseBlockRemoved,
    CourseBlockModified,
...
public static class AppMaterialLayer
{
    ...
    private static string ResourceKey(AppColorRole role) =>
        role switch
        {
            ...
            AppColorRole.CourseBlockLocked => "AppCourseBlockLockedBrush",
            AppColorRole.CourseBlockLockedHover => "AppCourseBlockLockedHoverBrush",
            AppColorRole.CourseBlockOutOfWeek => "AppCourseBlockOutOfWeekBrush",
            AppColorRole.CourseBlockOutOfWeekHover => "AppCourseBlockOutOfWeekHoverBrush",
            AppColorRole.CourseBlockOutOfWeekText => "AppCourseBlockOutOfWeekTextBrush",
